...
document.addEventListener("DOMContentLoaded", function () {
    const ctx = document.getElementById('2025_processos_com_andamento_fechado_na_cep_barra').getContext('2d');
    let grafico;

    const csvUrl = 'https://raw.githubusercontent.com/cep-der/website-/main/data/data_stat/2025/estatisticas_da_unidade_SEIPro_processos_com_andamento_fechado_na_cep.csv';
        ...
        grafico = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: '2025 PROCESSOS COM ANDAMENTO FECHADO NA CEP',
                        font: { size: 18 }
                    },
                    legend: {
                        display: true,
