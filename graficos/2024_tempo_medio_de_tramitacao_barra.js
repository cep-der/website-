...
document.addEventListener("DOMContentLoaded", function () {
    const ctx = document.getElementById('2024_tempo_medio_de_tramitacao_barra').getContext('2d');
    let grafico;

    const csvUrl = 'data/data_stat/2024/estatisticas_da_unidade_SEIPro_tempo_medio_de_tramitacao.csv';
        ...
        grafico = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: '2024 TEMPO MEDIO DE TRAMITACAO',
                        font: { size: 18 }
                    },
                    legend: {
                        display: true,
