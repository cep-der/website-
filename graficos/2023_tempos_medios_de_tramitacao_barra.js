...
document.addEventListener("DOMContentLoaded", function () {
    const ctx = document.getElementById('2023_tempos_medios_de_tramitacao_barra').getContext('2d');
    let grafico;

    const csvUrl = 'data/data_stat/2023/estatisticas_da_unidade_SEIPro_tempos_medios_de_tramitacao.csv';
        ...
        grafico = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: '2023 TEMPOS MEDIOS DE TRAMITACAO',
                        font: { size: 18 }
                    },
                    legend: {
                        display: true,
