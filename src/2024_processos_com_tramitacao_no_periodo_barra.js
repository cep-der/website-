...
document.addEventListener("DOMContentLoaded", function () {
    const ctx = document.getElementById('2024_processos_com_tramitacao_no_periodo_barra').getContext('2d');
    let grafico;

    const csvUrl = 'data/data_stat/2024/estatisticas_da_unidade_SEIPro_processos_com_tramitacao_no_periodo.csv';
        ...
        grafico = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: '2024 PROCESSOS COM TRAMITACAO NO PERIODO',
                        font: { size: 18 }
                    },
                    legend: {
                        display: true,
