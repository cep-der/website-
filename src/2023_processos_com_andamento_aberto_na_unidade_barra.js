...
document.addEventListener("DOMContentLoaded", function () {
    const ctx = document.getElementById('2023_processos_com_andamento_aberto_na_unidade_barra').getContext('2d');
    let grafico;

    const csvUrl = 'data/data_stat/2023/estatisticas_da_unidade_SEIPro_processos_com_andamento_aberto_na_unidade.csv';
        ...
        grafico = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: '2023 PROCESSOS COM ANDAMENTO ABERTO NA UNIDADE',
                        font: { size: 18 }
                    },
                    legend: {
                        display: true,
