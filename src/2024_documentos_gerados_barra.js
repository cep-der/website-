...
document.addEventListener("DOMContentLoaded", function () {
    const ctx = document.getElementById('2024_documentos_gerados_barra').getContext('2d');
    let grafico;

    const csvUrl = 'data/data_stat/2024/estatisticas_da_unidade_SEIPro_documentos_gerados.csv';
